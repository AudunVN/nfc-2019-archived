...
function scaleNavBg() {
	$(".main-nav-background-container").css({top: -$(".nfc-main-nav").offset().top+$(window).scrollTop()+"px"});
}

$('#main-menu').on('shown.bs.modal', function (e) {
    scaleNavBg();
    setTimeout(scaleNavBg, 150);
});
...
$(document).ready(function () {
    ...
    if (document.querySelector("#sub-page")) {
        onElementHeightChange(document.body, function () {
            if (document.body.clientHeight-document.querySelector(".main-footer").clientHeight < 14*65 /*em*/) {
                $("body").removeClass("long-document");
                $("body").addClass("short-document");
            } else {
                $("body").addClass("long-document");
                $("body").removeClass("short-document");
            }
        });
    }
